<span class="pull-right"><?php echo anchor("home/list", '<button class="btn btn-default"><span class="glyphicon glyphicon-th-list" /></span></button>', 'title="Lista"'); ?></span>
	...
	<?php for($i = 0; $i<3; $i++) { ?>
	  <div class="row">
        ...
        <div class="col-md-4">
		  ...
		  <div class="clearfix">
          <p ><?php echo substr($r->Review, 0, 512) . ' ...'; ?></p>
		  </div>
