<div id="main_content">
	...
	<?php if($canEdit )
	{
		...
		echo  '<a id="edit_title" href="" title="Dodaj"  class="toggle right" ></a>'
			...
			. '<p class="left">Modyfikuj tytuł: ' . form_input('movie_title',set_value('movie_title',$movie->MovieTitle),'maxlength="100" class="required"')
			. ' Oryginalny tytuł: '
	...
	?>
	<p id="movie_rating" class="clear">Średnia ocena: <span><?php echo round($rating,2); ?></span></p>
	...
	<div id="dialog" title="Zgło¶ bł±d">
			<div id="loading">
			</div>
			<div id="result">
			<p>Dziękuję za zgłoszenie błędu</p>
			</div>
			<form>				
